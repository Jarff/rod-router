<head>
	...
	<!-- Custom-Files -->
	<link rel="stylesheet" href="./src/assets/pages/css/bootstrap.css">
	<!-- Bootstrap-Core-CSS -->
	<link rel="stylesheet" href="./src/assets/pages/css/style.css" type="text/css" media="all" />
	<!-- Style-CSS -->
	<link href="./src/assets/pages/css/font-awesome.min.css" rel="stylesheet">
